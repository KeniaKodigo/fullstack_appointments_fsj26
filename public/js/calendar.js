document.addEventListener('DOMContentLoaded', function () {
    const appointments = window.calendarAppointments; //lista de citas
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventContent: function(arg) {
            ...
            if (status === 'pendiente') {
                container.style.backgroundColor = '#892b17'; // amarillo
            } else if (status === 'confirmado') {
                container.style.backgroundColor = '#224523'; // verde
